...
def main():
    if len(sys.argv) > 1 and sys.argv[1] in ['balboa', 'elpris', 'ngenic', 'sigenergy', 'aqualink', 'aquatemp', 'airquality', 'backup_influx', 'tapo']:
        module_name = sys.argv[1]
        logging.info(f"Running module: {module_name}")
        for m in [balboa, elpris, ngenic, sigenergy, aqualink, aquatemp, airquality, backup_influx, tapo]:
